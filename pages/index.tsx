    ...
    <div className='flex flex-col min-h-screen bg-gray-900 overflow-hidden relative lg:min-w-[1440px]'>
      ...
      <main className='flex-1 w-full mt-16 text-gray-300 px-6 md:px-8 lg:px-12 overflow-y-auto scrollbar-hide'>
        <section className='mb-12' id='about'>
          <h1 className='text-6xl sm:text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-100 to-purple-800 via-green-500 whitespace-nowrap'>
            Hello, I&apos;m Tom.
          </h1>
        ...
        <section className='mb-12' id='projects'>
          <h2 className='text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-100 to-purple-800 via-green-500 whitespace-nowrap'>
            Showcase
          </h2>
