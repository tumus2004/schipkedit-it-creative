...
const Header: React.FC = () => {
	...
	return (
		<header className='w-full z-20 fixed top-0 left-0 px-6 py-4 flex items-center justify-between md:px-8 lg:px-12 bg-stone-900 text-white rounded-lg shadow-xl backdrop-filter backdrop-blur-lg bg-opacity-30'>
			...
			>
				<button aria-label='Close menu' className='absolute top-5 right-5' onClick={toggleMenu}>
					<svg
						viewBox='0 0 24 24'
						width='24'
						height='24'
				...
				<Link className='text-gray-300 hover:text-blue-500 transition-colors duration-300 whitespace-nowrap' href='#'>
					About
				</Link>
				<Link className='text-gray-300 hover:text-blue-500 transition-colors duration-300 whitespace-nowrap' href='#'>
					Projects
